...
int KeyMngClientOp_SUNNY::MngClient_InitInfo(MngClient_Info *pCltInfo)
{
	
	int 			ret = 0;
	//读配置文件
	LogHelper::KeyMng_Log(__FILE__, __LINE__,LogHelper::KeyMngLevel[1], ret,"func main() MngClient_InitInfo() begin");
	...
	LogHelper::KeyMng_Log(__FILE__, __LINE__,LogHelper::KeyMngLevel[1], ret,"func main() MngClient_InitInfo() end");
	return 0;
}
...
int  KeyMngClientOp_SUNNY::MngClient_Agree(MngClient_Info *pCltInfo)
{
	...
	if (ret != 0)
	{
		LogHelper::KeyMng_Log(__FILE__, __LINE__,LogHelper::KeyMngLevel[4], ret,"func MsgEncode() err:%d \n", ret);
		LogHelper::KeyMng_Log(__FILE__, __LINE__,LogHelper::KeyMngLevel[4], ret,"func main() KeyMng_ShmInit() err");
		goto End;
	}
	...
	if (ret != 0)
	{
		LogHelper::KeyMng_Log(__FILE__, __LINE__,LogHelper::KeyMngLevel[4], ret,"func sckClient_init() err:%d \n", ret);
		goto End;
	}
	...
	if (ret != 0)
	{
		LogHelper::KeyMng_Log(__FILE__, __LINE__,LogHelper::KeyMngLevel[4], ret,"func sckClient_connect() err:%d serverip:%s, serverport:%d", ret, pCltInfo->serverip, pCltInfo->serverport);
		goto End;
	}
	...
	if (ret != 0)
	{
		LogHelper::KeyMng_Log(__FILE__, __LINE__,LogHelper::KeyMngLevel[4], ret,"func sckClient_send() err:%d \n", ret);
		goto End;
	}
	...
	if (ret != 0)
	{
		LogHelper::KeyMng_Log(__FILE__, __LINE__,LogHelper::KeyMngLevel[4], ret,"func sckClient_rev() err:%d \n", ret);
		goto End;
	}
	...
	if (ret != 0)
	{
		LogHelper::KeyMng_Log(__FILE__, __LINE__,LogHelper::KeyMngLevel[4], ret,"func MsgDecode() err:%d \n", ret);
		goto End;
	}
	...
	if (ret != 0)
	{
		LogHelper::KeyMng_Log(__FILE__, __LINE__,LogHelper::KeyMngLevel[4], ret,"func KeyMng_ShmWrite() err:%d \n", ret);
		goto End;
	}
End:
...
//接受服务器应答
//rv == 0;
int  KeyMngClientOp_SUNNY::MngClient_Check(MngClient_Info *pCltInfo)
{
...
int KeyMngClientOp_SUNNY::MngClient_Quit(MngClient_Info *pCltInfo)
{
		return 0;
}

int KeyMngClientOp_SUNNY::MngClient_Revoke(MngClient_Info *pCltInfo)
{
		return 0;
}

int KeyMngClientOp_SUNNY::MngClient_view(MngClient_Info *pCltInfo)
{
		return 0;	
}
