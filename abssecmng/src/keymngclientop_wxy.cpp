...
int KeyMngClientOp_WXY::MngClient_InitInfo(MngClient_Info *pCltInfo)
{
...
int  KeyMngClientOp_WXY::MngClient_Agree(MngClient_Info *pCltInfo)
{
...
//接受服务器应答
//rv == 0;
int  KeyMngClientOp_WXY::MngClient_Check(MngClient_Info *pCltInfo)
{
...
int KeyMngClientOp_WXY::MngClient_Quit(MngClient_Info *pCltInfo)
{
		return 0;
}

int KeyMngClientOp_WXY::MngClient_Revoke(MngClient_Info *pCltInfo)
{
		return 0;
}

int KeyMngClientOp_WXY::MngClient_view(MngClient_Info *pCltInfo)
{
		return 0;	
}
